...
const KDOG_WBNB_PAIR = '0xD995D5Dde44C49ea7aA712567fcA9ddaB842A1f1';
const KDOG_KGST_PAIR = '0x14C90904dD8868c8E748e42D092250Ec17f748d1';

const KDOG = '0x3753dd32cbc376ce6efd85f334b7289ae6d004af';
const WBNB = '0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c';
const KGST = '0x94be0bbA8E1E303fE998c9360B57b826F1A4f828';

async function checkPairLiquidity(pairAddress, pairName, expectedToken0, expectedToken1, token0Name, token1Name) {
  console.log(`\n${'='.repeat(60)}`);
  ...
  try {
    ...
    let kdogReserve, otherReserve, otherTokenName;
    ...
    console.error(`Error querying ${pairName}:`, error.message);
    return null;
  }
}
